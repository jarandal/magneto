 ...
 */
class Devinc_Groupdeals_Block_Adminhtml_Groupdeals_Edit_Renderer_Urlkey extends Mage_Adminhtml_Block_Catalog_Form_Renderer_Fieldset_Element
{
    public function getElementHtml()
    {
        ...
        $data = array(
            'name' => str_replace(']','',$element->getData('name')) . '_create_redirect]',
            'disabled' => true,
        );
