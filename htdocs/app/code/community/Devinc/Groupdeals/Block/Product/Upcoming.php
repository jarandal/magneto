<?php
class Devinc_Groupdeals_Block_Product_Upcoming extends Devinc_Groupdeals_Block_Product_List
{	
	//add breadcrumbs
    protected function _prepareLayout()
    {
        ...
        if ($this->getLayout()->getBlock('head') && $city) {
            $this->getLayout()->getBlock('head')->setTitle($this->__('%s - Upcoming Deals', $city));
        }
