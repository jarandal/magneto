...
class Devinc_Groupdeals_Model_Facebook_Config
{
    ...
    {
        if( Mage::helper('groupdeals')->isEnabled() && (Mage::getStoreConfigFlag(self::XML_PATH_ENABLED, $storeId) || Mage::getStoreConfigFlag('groupdeals/facebook_connect/enable_facebook_like', $storeId) || Mage::getStoreConfigFlag('groupdeals/facebook_connect/enable_facebook_comments', $storeId)) && 
