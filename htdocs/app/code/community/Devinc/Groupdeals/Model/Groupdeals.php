		...
		foreach ($stores as $_eachStoreId => $val) 
		{
			...
			if ($store->getRootCategoryId()) {
				...
				if (Mage::helper('groupdeals')->isMagentoEnterprise()) {
					...
					$sql= "UPDATE ".$resource->getTableName('enterprise_url_rewrite')." SET target_path='groupdeals/product/view/id/".$productId."/groupdeals_id/".$groupdealId."' WHERE target_path='catalog/product/view/id/".$productId."'; commit;";
