<?php
class Devinc_License_Block_Adminhtml_System_Config_Form_Label extends Mage_Adminhtml_Block_System_Config_Form_Field
{    	
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html.= '<div style="padding:5px;">'.$label.'</div>'."\n";                  
